...
- 3 أحرف أو أقل، أو رقم → **ENGLISH CAPITALS** (مثال: `C63`، `X5`، `GLE`)

**الحالة:** لم تُطبَّق بعد في `normalizer.py`
...
**الهدف:** حفظها في أعمدة `ميزات` و`ميزات السلامة` في Sayarti.

**الحالة:** لم تُطبَّق بعد — يحتاج فحص أي مواقع تدعم هذا
